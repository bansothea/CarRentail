...
class SplashCarConfidentlyScreen extends StatelessWidget {
  const SplashCarConfidentlyScreen({super.key});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
               ...
               const Text("Druve confidently with your choice of protection plan. All plans include varying level of insurance from fakeh Insurance",
                  style: TextStyle(
                    fontSize: 15,
